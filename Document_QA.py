...
class QA():
    def __init__(self,data_embe) -> None:
        ...
        self.index = index
        self.data = data
    def __call__(self, query,shenfen_text_path):
        embedding = create_embedding(query)
        context = self.get_texts(embedding[1], limit)
        answer = self.completion(query,context,shenfen_text_path)
    ...
    def completion(self,query, context,shenfen_text_path):
        """Create a completion."""
        ...
        response = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {"role": "assistant", "content":shenfen_data},
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if query == "quit":
            ...
            print("输入quit退出")
            continue
        answer,context = qa(query,shenfen_text_path)
